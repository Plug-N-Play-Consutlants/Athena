"""Validation for v0.5.5.5.21 file usefulness audit."""
...
def main() -> int:
    ...
    doc_path = root / "docs" / "FILE_USEFULNESS_AUDIT_v0.5.5.5.21.md"
    inventory_path = root / "docs" / "FILE_USEFULNESS_INVENTORY_v0.5.5.5.21.csv"
    ...
    assert_true("version_metadata", '0.5.5.5.21' in version_text, "Core/version.py", results)
