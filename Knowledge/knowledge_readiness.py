...
KNOWLEDGE_DOMAINS = [
    ...
    },
    {
        ...
        "required": ["transactions", "transaction_master", "transaction_history"],
        "description": "Current-season transaction timeline, asset movement, free-agent additions, waiver claims, drops, and fees.",
    ...
    },
    {
        ...
        "required": ["transaction_history", "manager_behavior"],
        "description": "Observable manager tendencies inferred from canonical transaction history.",
        "impact": "Supports realistic trade partner identification and decision-support options.",
    },
    {
        "domain": "league_market",
        "required": ["transaction_history", "manager_behavior", "league_market"],
        "description": "League-specific market activity, liquidity, transaction style, waiver/free-agent behavior, and fee activity.",
